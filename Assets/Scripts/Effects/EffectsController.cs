...
public class EffectsController : MonoBehaviour
{
	...
	//public GameObject bouncePuff, wallPuff;
	
	public GameObject dustPuff, turnAroundPuff;
	
	//public GameObject smokeRing, smokeRingWhite, lineParticle;

	//public GameObject confetti;

	public GameObject shingEffect;

	//public GameObject teleportSolo;

	//public GameObject teleportMewtwo;
	...
	//public static void SetCameraWobble(Vector2 cameraWobbleSpeed, Vector2 cameraWobbleAmount)
	//{
	//	instance.cameraWobbleSpeed = cameraWobbleSpeed;
	//	instance.cameraWobbleAmount = cameraWobbleAmount;
	//}

	//public static void CreateTeleportSolo(Vector3 pos)
	//{
	//	Instantiate(instance.teleportSolo, pos, Quaternion.identity);
	//}

	//public static void CreateTeleportMewtwo(Vector3 pos)
	//{
	//	Instantiate(instance.teleportMewtwo, pos, Quaternion.identity);
	//}
	...
	//public static void CreateSmokeRingWhite(Vector3 pos, Quaternion rot, Color col)
	//{
	//	var sr = Instantiate(instance.smokeRingWhite, pos - Vector3.forward * 3f, rot) as GameObject;
	//}
	...
	//	var cf = sr.GetComponent<Confetti>();
	//	cf.velocity = velocity;
	//	cf.sr.color = col;
	...
	//		Camera.main.transform.position = Vector3.Lerp(p, wobbleVector - Vector3.forward * 40f, Time.deltaTime * 3f);
	//	}
	...
	//				var cf = Instantiate(confetti, new Vector3(x, y, -1f), Quaternion.identity).GetComponent<Confetti>();
	//				cf.velocity = new Vector3(Random.Range(-1f, 1f), Random.Range(-0.5f, -2f), 0f);
	//				cf.sr.color = GetRandomColor();
	//			}
	...
	{
		float rot = 0f;
		//attackDirection = new Vector2(attackDirection.x, 0);
		...
		se.transform.position += new Vector3(0, -2, 0);
	...
	public static void CreateJumpPuffStraight(Vector2 pos, Side orientation)
	{
		...
		jp.transform.position += new Vector3(0, -2, 0);
	}
	...
	//	//traile.transform.localScale = Vector3.Cross(animator.rend.transform.localScale, animator.rend.flipX ? Vector3.left : Vector3.right);
	//	traile.spriteRenderer.material.color = color;
	//	traile.spriteRenderer.sprite = animator.rend.sprite;
	//	traile.spriteRenderer.flipX = animator.rend.flipX;
	//	color.a = 0.5f;
	...
	internal static void CreateTurnAroundPuff(Vector3 position, float dir)
	{
		...
		dp.transform.position += new Vector3(-dir*2, -3, 0);
	}
}
